	...
	<form method="GET">
		<div class="mae">
			...
			<div class="resultado">
				<hr>
				<?php
				$a = $_GET["nmr1"]; // Variavel a pega o name="nmr1"
				$b = $_GET["nmr2"]; // Variavel b pega o name="nmr2
				$op = $_GET["operacao"]; // variavel op pega o name="operacao"
				$c = []; // varivel não pega nada
